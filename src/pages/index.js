	...
	return (
			<div className={styles.home_main}>
				<section className={styles.grid_intro}>
					...
					<p>I'm a software engineer in Boston (she + her + hers) who specializes in creating outstanding solutions for people and professionals alike.  Right now I'm on a team with Crocodile Labs building the <a href='https://ambient.finance/' target='_blank' rel='noreferrer'>Ambient Finance</a> platform.</p>
